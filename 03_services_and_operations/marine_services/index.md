...
- **URL:** [https://nigerianports.gov.ng/marine-services/](https://nigerianports.gov.ng/marine-services/)
- **Section:** `03_services_and_operations/marine_services`
- **Slug:** `marine-services` | **Page ID:** `216`
- **Published:** `2017-01-23T21:56:11` | **Last Modified:** `2026-02-17T16:56:05`

## Sub-Pages & Child Sections
- [Distances to African Ports](distances_to_african_ports.md) (`https://nigerianports.gov.ng/marine-services/distances-to-african-ports/`)
- [Dredging](dredging.md) (`https://nigerianports.gov.ng/marine-services/dredging/`)
- [Vessel Maintenance & Docking](vessel_maintenance_and_docking.md) (`https://nigerianports.gov.ng/marine-services/vessel-maintenance-docking/`)
...
**_Procedure_**
  ...
  * The activities involve dredging, wreck removal, provision of navigational aids and general channel management aimed at providing 24/7 safe and secured pilotage in all the Pilotage Districts.
...
#### __Monitoring of Bunkering

**_Procedure_**

  * Ashore – Ship Agent makes application to Port Manager (PM)
  * Tariff & Billing department raises Debit Note
...
#### __Mid-Stream Operations

**_Procedure_**

  * Application for Mid-stream Operations is made to the Minister, Federal Ministry of Marine and Blue Economy (FMMBE).
  * TheFMMBE forwards same to NPA for Technical/Safety Input.
...
#### __Ship-to-Ship/Ship-to-Rig Operations (STS/STR)
...
#### __Oil Terminal Dues (OTD) & Compulsory Pilotage Royalty (CPR) 
